            ...
            <div class="row">
                <div class="col-md-2 col-sm-4">
                    <div class="timeline-thumb">
                        <div class="thumb">
                            <img src="{{URL::asset('images/timeline1.jpg')}}"
                                 alt="">
                        </div>
                        <div class="overlay">
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="timeline-thumb">
                        <div class="thumb">
                            <img src="{{URL::asset('images/timeline2.jpg')}}"
                                 alt="">
                        </div>
                        <div class="overlay">
                            <div class="timeline-caption">
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="timeline-thumb">
                        <div class="thumb">
                            <img src="{{URL::asset('images/timeline3.jpg')}}"
                                 alt="">
                        </div>
                        <div class="overlay">
                            <div class="timeline-caption">
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="timeline-thumb">
                        <div class="thumb">
                            <img src="{{URL::asset('images/timeline4.jpg')}}"
                                 alt="">
                        </div>
                        <div class="overlay">
                            <div class="timeline-caption">
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="timeline-thumb">
                        <div class="thumb">
                            <img src="{{URL::asset('images/timeline5.jpg')}}"
                                 alt="">
                        </div>
                        <div class="overlay">
                            <div class="timeline-caption">
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="timeline-thumb">
                        <div class="thumb">
                            <img src="{{URL::asset('images/timeline6.jpg')}}"
                                 alt="">
                        </div>
                        <div class="overlay">
                            <div class="timeline-caption">
                ...
                <div class="authors">
                    <div class="col-md-3 col-sm-6">
                        <div class="team-thumb">
                            <div class="author">
                                <img src="{{URL::asset('images/author1.jpg')}}"
                                     alt="Tracy - templatemo">
                            </div>
                            <div class="overlay">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team-thumb">
                            <div class="author">
                                <img src="{{URL::asset('images/author2.jpg')}}"
                                     alt="Mary - templatemo">
                            </div>
                            <div class="overlay">
                                <div class="author-caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team-thumb">
                            <div class="author">
                                <img src="{{URL::asset('images/author3.jpg')}}"
                                     alt="Julia - templatemo">
                            </div>
                            <div class="overlay">
                                <div class="author-caption">
                                    <ul>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team-thumb">
                            <div class="author">
                                <img src="{{URL::asset('images/author4.jpg')}}"
                                     alt="Linda - templatemo">
                            </div>
                            <div class="overlay">
                                <div class="author-caption">
                                    <ul>
